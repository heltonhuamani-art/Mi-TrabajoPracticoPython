...
class ParcelaAgricola:
    ...
    def __init__(
        self,
        id_parcela,     #asignar ID desde la interfaz
        nombre,         #asignar nombre desde la interfaz
        area_hectareas,
        distancia_surcos_m,
        distancia_plantas_m,
        germinacion_pct,
        ...
        self.id = id_parcela   # <--- asignar ID desde la interfaz
        self.nombre = nombre   # <--- asignar nombre desde la interfaz
        ...
        validar_positivo(self.id, "id_parcela")
